...
var btnReview = document.querySelector(".btn-contest--review");
var userName = document.querySelector(".fullname__name");
var userSurname = document.querySelector(".fullname__surname");
var tel = document.querySelector(".contacts-form__phone");
var email = document.querySelector(".contacts-form__email");
